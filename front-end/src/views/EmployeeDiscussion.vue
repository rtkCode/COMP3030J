      ...
      <div>
        ...
        <div class="col-12 row d-flex flex-wrap-reverse">
          <div class="col-lg-12 col-md-12 col-sm-12 col mx-2 p-0">
            <div v-for="(a,index) in appointments_employee" :key="index">
              <div
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              data-dismiss="modal"
            >{{$t("string.button.close")}}</button>
            <button
              type="button"
              class="btn btn-danger"
              @click="updateStatus(deleteId, 'Canceled')"
              v-show="showButton"
            >{{$t("string.button.confirm")}}</button>
...
export default {
  ...
  created() {
    document.title = `Employee Discussion | ${this.hospital}`;
  },
  ...
  methods: {
    ...
    handleAppointments(appointments) {
      for (let i = 0; i < appointments.length; i++) {
        this.appointments_employee.push(appointments[i]);
      }
    },
