  ...
  <div>
    ...
    <div class="content">
      <div class="title text-left text-info mt-4 p-2 mx-5 d-flex justify-content-between">
        <h3>There are currently <strong>{{appointments.length}}</strong> appointments in the system.</h3>
        <router-link to="/employee/personal" type="button" class="btn btn-outline-info d-flex justify-content-center align-items-center">Personal Panel</router-link>
      </div>
      ...
      <div class="text-left mx-4 px-4">
        ...
        <a class="text-secondary" data-toggle="collapse" href="#filterCollapse" aria-expanded="false" aria-controls="filterCollapse">Show filter</a>
      </div>

      <div class="mx-4 p-2 collapse" id="filterCollapse">
        <div class="px-4 py-2 mx-2">
          <h5 class="text-left ml-1">Status</h5>
        ...
        <div class="px-4 py-2 mx-2">
          <h5 class="text-left ml-1">Pet</h5>
          <div class="d-flex flex-wrap">
        ...
        <div class="px-4 py-2 mx-2">
          <div class="d-flex flex-wrap">
            <a class="btn btn-success button-c p-2 m-2" data-toggle="collapse" href="#filterCollapse" aria-expanded="false" aria-controls="filterCollapse" @click="getAppointments()">Confirm</a>
            <a class="btn btn-outline-danger button-c p-2 m-2" data-toggle="collapse" href="#filterCollapse" aria-expanded="false" aria-controls="filterCollapse">Cancel</a>
          </div>
        </div>
      </div>
